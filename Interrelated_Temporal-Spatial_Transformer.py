...
class GAM_Transformer(nn.Module):
    def __init__(self, input_size, patch_size,channels, num_classes, model_dim,
        ...
        super(GAM_Transformer, self).__init__()
        ...
        self.SA_Encoder = SA_Encoder(dim=input_size, depth=8, channels=channels, channel_rate=channel_rate,
                                     dropout=0.1)
        self.CA_Encoder = CA_Encoder(dim=input_size, depth=8, channels=channels, channel_rate=channel_rate,
                                     dropout=0.1)
